...
/*fn thread_encode( thread_num: mut u32, des_file: &mut [String], thread_total: u32, message_slice: &mut [String],  ref2:mut u32, array_of_file_name_number: &mut [u32]){
    let mut ref1=0;
    let mut image= &des_file[ref1];
    let slice */
